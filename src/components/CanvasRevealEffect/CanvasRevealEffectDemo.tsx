  ...
  return (
    <>
      <div className="py-[-10px] flex flex-col lg:flex-row items-center justify-center bg-black/[0.96] antialiased bg-grid-white/[0.04] w-full gap-4 mx-auto px-8">
        <Card
          title=" Swap between 19 networks, 14 bridges and 33 DEX"
          description="Swap"
          icon={<SwapIcon />}
        >
          <CanvasRevealEffect
        ...
        <Card
          title="Open market with customizable interest rates and conventional lending in a single platform"
          description="Dual System"
          icon={<Borrow />}
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="Filter and pick the best loan
for your needs"
          description="Borrow"
          icon={<DualSystemIcon />}
        >
