...
const CrewCard: React.FC<ICardProps> = ({
  ...
  return (
    <div className={`card flex-col   ${containerClass}`}>
      ...
      <div
        className={`card flex-row max-w-36 bg-black min-w-60 border-2 border-b border-gray-700 transition-all duration-300 transform hover:scale-105 hover:shadow-[5px_5px_0px_0px_#6D28D9] hover:border-tulia-purple rounded-lg ${containerClass}`}
